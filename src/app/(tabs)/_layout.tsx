  ...
  return (
    <Tabs
      screenOptions={{
        ...
        tabBarButton: (props: any) => <Pressable {...props} android_ripple={{ color: "transparent" }} />,
      }}
    >
      {/* REKAM MEDIS */}
      <Tabs.Screen
      ...
      <Tabs.Screen
        ...
        options={{
          ...
          tabBarButton: ({ onPress, children, ...props }: any) => {
            ...
            return (
              <Pressable {...props} onPress={onPress} android_ripple={{ color: "rgba(255,255,255,0.1)", borderless: true }} className="flex-1 justify-center items-center active:bg-white active:opacity-60 rounded-full">
                <SymbolView name={{ ios: "bell", android: "notifications" }} tintColor={isFocused ? "#ffffff" : "#888"} size={35} />
              </Pressable>
            );
          },
        }}
