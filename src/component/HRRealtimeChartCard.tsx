...
export const HRRealtimeChartCard: React.FC<Props> = ({ data }) => {
  ...
  // 1. REVISI: Kalkulasi maxValue dinamis berdasarkan data tertinggi + margin atas
  ...
  return (
    <Cards className="flex flex-col gap-3">
      <View className="flex-row items-center justify-between">
        ...
        {/* <Text className="text-xs text-gray-400">Live Stream</Text> */}
      </View>
      ...
      <View className="overflow-hidden mt-1">
        <LineChart
          ...
          thickness={2.5}
          color="#DB3546"
          startFillColor="rgba(219, 53, 70, 0.25)"
          endFillColor="rgba(219, 53, 70, 0.0)"
          startOpacity={0.3}
          endOpacity={0.0}
          areaChart
          curved
          ...
          // REVISI 2: Auto Scroll ke Kanan saat Data Baru Masuk
          scrollToEnd={true}
